...
class DeleteCityDialogFragment : DialogFragment() {
    ...
    companion object {
        val EXTRA_CITY_NAME = "com.mathieu.cauchy.tp_final_android.extras.EXTRA_CITY_NAME"
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        builder.setTitle(getString(R.string.deletecity_title, cityName))
            ...
            .setNegativeButton(getString(R.string.deletecity_negative)) { _, _ -> listener?.onDialogNegativeClick()}
